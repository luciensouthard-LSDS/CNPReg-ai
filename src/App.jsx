...
- Vegetables: weekly subgroups - dark green, red/orange, beans/peas, starchy, other
- Offer vs. serve permitted for lunch
Section 210.15 Recordkeeping: SFAs must retain records 3 years plus current year.
Section 210.18 Administrative reviews: State agencies must review each SFA at least once every 3 years.

7 CFR PART 220 - SCHOOL BREAKFAST PROGRAM (SBP)
Section 220.8 Meal requirements:
...
Section 226.20 Meal requirements - Children:
...
- Infants 6-11 months: breast milk/formula plus age-appropriate foods

7 CFR PART 225 - SUMMER FOOD SERVICE PROGRAM (SFSP)
Section 225.16 Meal service: Open sites must serve all children 18 and under.

7 CFR PART 245 - ELIGIBILITY FOR FREE AND REDUCED PRICE MEALS
Section 245.6 Income eligibility:
- Free meals: household income at or below 130% Federal Poverty Level
- Reduced price: 130-185% FPL; max charge $0.40 lunch, $0.30 breakfast
Section 245.6a Direct Certification: SFAs must directly certify children in SNAP, TANF, or FDPIR households.
Section 245.9 Community Eligibility Provision (CEP):
- CRITICAL: ISP threshold is 25% (NOT 40% - that was the old threshold)
- ISP = directly certified students divided by total enrolled times 100
- Claiming percentage = ISP times 1.6 (capped at 100%)
- Schools/LEAs with ISP of 25% or greater may elect CEP
- 4-year cycle
Section 245.11 Verification: SFAs must verify 3% or 3,000 applications (whichever is less) annually.

7 CFR PART 215 - SPECIAL MILK PROGRAM
Provides milk to children in schools not participating in other Federal meal programs.

7 CFR PART 235 - STATE ADMINISTRATIVE EXPENSE FUNDS
Funds allocated to State agencies for oversight and administration of Child Nutrition Programs.

7 CFR PART 240 - CASH IN LIEU OF DONATED FOODS
States/SFAs may elect cash payments in lieu of USDA donated foods.

7 CFR PART 292 - SUMMER EBT PROGRAM
Provides EBT benefits to children eligible for free/reduced price meals during summer.
...
- FSMC contracts: max 5-year term

CIVIL RIGHTS - 7 CFR PART 15
- No discrimination based on race, color, national origin, sex, age, or disability
...
export default function App() {
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      const geminiUrl = "https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash-lite:generateContent?key=" + geminiKey;
